  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setAlto(datausuario.alto);
        setLargo(datausuario.largo);
        setAncho(datausuario.ancho);
        setPeso(datausuario.peso);
        setDireccionRecogida(datausuario.direccion_recogida);
        setCiudadRecogida(datausuario.ciudad_recogida);
        setNombreDestinatario(datausuario.nombre_destinatario);
        setCedulaDestinatario(datausuario.cedula_destinatario);
        setDireccionEntrega(datausuario.direccion_entrega);
        setCiudadEntrega(datausuario.ciudad_entrega);
      });
  }, []);
